...
class Store extends StoreAbstract
{
    ...
    {
        $service = new Domain\InvoiceFile\Store($this->user, ['main' => true]);
    ...
    {
        Domain\InvoiceSerie\StoreNumber::setNext($this->row->serie);
    }
    ...
    {
        $fileStore = new Domain\InvoiceFile\Store($this->user);
