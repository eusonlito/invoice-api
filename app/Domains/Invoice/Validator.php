    ...
    public static function configUpdate(): array
    {
        return [
            ...
            'messages' => [
                ...
                'invoice_recurring_id.integer' => __('validator.invoice_recurring_id-integer'),
                ...
                'amount_shipping_subtotal.numeric' => __('validator.amount_shipping_subtotal-numeric'),
                'amount_shipping_tax_percent.numeric' => __('validator.amount_shipping_tax_percent-numeric'),
