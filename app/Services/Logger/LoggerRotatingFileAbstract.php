...
abstract class LoggerRotatingFileAbstract
{
    /**
     * @var array
     */
     ...
     * @return void
     */
    public static function info(string $title, $data = [])
    {
     ...
     * @return void
     */
    public static function error(string $title, $data = [])
    {
        static::write(__FUNCTION__, $title, $data);
    }
     ...
     * @return void
     */
    protected static function write(string $status, string $title, $data = [])
    {
